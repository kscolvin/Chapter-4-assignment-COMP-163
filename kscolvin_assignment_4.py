...
# Part 3 : Final Semester Assessment
# The player will make a final decision that will determine their success in the semester.

# Final Decisions
final_choice = input("Final Decision: Do you want to pull an all-nighter, sleep early, or seek help from your professor to help for your final exams? (All Nighter/Sleep Early/Help): ")
if final_choice == "All Nighter":
    current_gpa = current_gpa - 1.0
    stress_level = stress_level + 20
    print("You pulled an all-nighter! Your GPA decreases and your stress level skyrockets.") # Pulling an all-nighter is detrimental to your health and performance, it decreases GPA significantly and increases stress level significantly because you're not getting enough sleep and you're overworking yourself.
elif final_choice == "Sleep Early":
    current_gpa = current_gpa + 0.1
    stress_level = stress_level - 10
    print("You decide to sleep in early. Your GPA increases slightly and your stress level decreases.") # Sleeping early is beneficial, it improves GPA slightly and reduces stress level because you're getting enough rest and you're not overworking yourself.
elif final_choice == "Help":
    current_gpa = current_gpa + 0.5
    stress_level = stress_level - 5
    study_hours = study_hours + 5
    print("You sought help from your professor! Your GPA increases and your stress level decreases slightly.") # Seeking help from your professor is very beneficial, it improves GPA significantly and reduces stress level slightly because they LOWKEY just give you the answers.
else:
    print("Invalid choice. Please choose 'All Nighter', 'Sleep Early', or 'Help'.")

# Multiple Endings
# Final Stats
print()
print("-- Final Stats --")
print("Final GPA:", f"{current_gpa:.2f}")
